...
- **Sub-feature waves W1–W10 (feature/subfeatures)** — DONE + **DEPLOYED to production 2026-09-04** (owner approved; merged to main `0ce9787..d7eab02`): apply `statusHistory` `134e8e7`, review helpful votes `fd11200`, `/users/export` CSV `aab46f4`, notifications `0d7dd07`, question follow `b4a5e2d`. See handoff 2026-09-04.
