...
const INSTITUTIONS = [
  ...
  },
  {
    ...
    orgCountry: "United Kingdom",
    orgWebsite: "https://www.ox.ac.uk",
    orgDescription: "Official news and scholarship office of the University of Oxford, coordinating the Reach Oxford and other flagship awards.",
    photoURL: "https://images.unsplash.com/photo-1592285897573-74b3a9a0c3f3?w=300&q=80",
    createdAt: new Date(),
    updatedAt: new Date(),
  },
];
...
const SCHOLARSHIPS_DATA = [
  ...
  },
  {
    universityName: "University of Oxford",
    scholarshipCategory: "Full-fund",
    scholarshipName: "Reach Oxford Scholarship",
    degree: "Bachelor",
    subjectName: "Any Subject",
    country: "United Kingdom",
    city: "Oxford",
    universityWorldrank: 1,
    universityImage: "https://images.unsplash.com/photo-1541339907198-e08756dedf3f?w=800&q=80",
    gallery: ["https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=800&q=80", "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=800&q=80"],
    applicationFees: 0,
    serviceCharge: 0,
    stipend: 18000,
    currency: "GBP",
    ...
    scholarshipDescription: "The Reach Oxford Scholarship is offered to students from low-income countries who, for political or financial reasons, cannot study for a degree in their own country. Funded by the University of Oxford and colleges, it covers course fees, college fees and a grant for living costs plus one return air fare per year. Applicants must be nationals of countries receiving official development assistance from the OECD and must have applied via UCAS to an Oxford undergraduate course. Selection is based on academic excellence, financial need and social commitment.",
    eligibility: ["National of a country receiving OECD development assistance", "New undergraduate applicant via UCAS by 15 Oct", "Unable to study in home country due to political or financial reasons", "Demonstrated academic excellence and financial need"],
    requirements: ["UCAS application to Oxford by 15 October", "Separate Reach Oxford application and financial declaration", "Academic transcripts and predicted grades", "References supporting financial need"],
    benefits: ["Full course fees and college fees covered", "Annual living costs grant (~£18,000)", "Return air fare each year", "Support from Oxford college and scholars community"],
    highlights: ["Needs-based full cover", "College fees included", "Annual flights included"],
    documents: ["UCAS application", "Reach Oxford application form", "Financial declaration", "Academic transcripts", "Reference letter"],
    tags: ["Reach Oxford", "Undergraduate", "Needs-based", "United Kingdom"],
    postDate: "2026-09-02",
    rating: 5,
    reviewsCount: 0,
    creatorEmail: "news.office@admin.ox.ac.uk",
    videoUrl: "https://www.youtube.com/watch?v=3s1aSZxmM3I",
    brochureUrl: "https://www.ox.ac.uk/admissions/undergraduate/fees-and-funding/oxford-support/reach-oxford-scholarship",
    mapUrl: "https://maps.google.com/?q=University+of+Oxford",
    faqs: [{ q: "Who can apply for Reach Oxford?", a: "Students who are nationals of countries receiving official development assistance and who have applied for an undergraduate course at Oxford." }, { q: "When is the deadline?", a: "UCAS by 15 October and the separate Reach Oxford application by February (2027-02-15 for this cycle)." }],
    status: "published",
  },
];
...
const REVIEWS_POOL = [
  ...
  {
    reviewer_name: "Olivia Smith",
    reviewer_email: "olivia.s@example.com",
    reviewer_image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&q=80",
    rating: 5,
    comment: "Reach Oxford changed my life — full support for fees, living and flights, plus a welcoming college community.",
    status: "approved",
  },
  {
    reviewer_name: "James Carter",
    reviewer_email: "james.c.ox@example.com",
    reviewer_image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&q=80",
    rating: 5,
    comment: "The most supportive scholarship I've seen — the application was clear and the stipend covers everything in Oxford.",
    status: "approved",
  },
];
